...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative h-dvh overflow-hidden flex flex-col">
      ...
      >
        <div className="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8">
          ...
          <div className="hidden lg:flex flex-col gap-3 p-5 rounded-2xl bg-white/[0.03] border border-white/[0.06] backdrop-blur-sm">
