...
export function ShaderBackground({ className }: ShaderBackgroundProps) {
  ...
  const fsSource = `
    ...
    const vec4 lineColor = vec4(0.38, 0.75, 0.6, 1.0);
    ...
    void main() {
      ...
      vec4 lines = vec4(0.0);
      vec4 bgColor1 = vec4(0.0235, 0.0314, 0.0392, 1.0);
      vec4 bgColor2 = vec4(0.0235, 0.0314, 0.0392, 1.0);
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      gl.clearColor(0.0235, 0.0314, 0.0392, 1.0)
